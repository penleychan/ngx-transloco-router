...
export declare class TranslocoDirective implements OnInit, OnDestroy, OnChanges {
    ...
    }>, providerScope: MaybeArray<TranslocoScope>, providerLang: string | null, providedLoadingTpl: Type<any> | string, vcr: ViewContainerRef, cdr: ChangeDetectorRef, host: ElementRef);
    ngOnInit(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<TranslocoDirective, [null, { optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }, null, null, null]>;
