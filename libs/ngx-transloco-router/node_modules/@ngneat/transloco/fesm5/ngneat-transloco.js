...
import { __assign, __values, __read, __extends, __spread } from 'tslib';
import { InjectionToken, Inject, Injectable, Injector, Optional, Component, Input, ChangeDetectorRef, Directive, ElementRef, TemplateRef, ViewContainerRef, Pipe, NgModule, ComponentFactoryResolver, APP_INITIALIZER, defineInjectable, inject } from '@angular/core';
